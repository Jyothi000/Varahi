...
if (submissionDetails) {
  ...
  if (data && currentPage === 'success.html') {
    // On success page, show the details (form is already hidden in HTML)
    ...
    `;
  } else if (data && currentPage !== 'success.html') {
    // Show details on other pages (if needed)
    const transferredUnits = parseInt(data.units, 10);
    const remainingUnits = getAvailableUnits();
